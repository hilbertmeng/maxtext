    ...
    if cfg.using_pipeline_parallelism:
      ...
      if cfg.scan_layers:
        ...
        if pair_scan:
          ...
          assert block_modes in (
              ['local_qk+local_o'] * (block_size - 1) + ['local_qk+full'],
              ['local_o'] * (block_size - 1) + ['full'],
          )
          assert cfg.bam_layer_modes == block_modes * (scan_length // block_size)
