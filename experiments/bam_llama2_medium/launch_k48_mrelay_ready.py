...
assert suffix in ('MRelayM3','MRelayM3QKVO')
run=base+suffix;ident='k48-mrelay-m3'+('-qkvo' if suffix.endswith('QKVO') else '')
bases=[base]+([base+'MRelayM3'] if suffix.endswith('QKVO') else [])
