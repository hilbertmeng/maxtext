...
"$CPU_PYTHON" experiments/bam_llama2_medium/audit_rmt_mha_budget.py \
  --exp-class RMTMediumPropK48DynamicFull48RoPE18VectorNormMHABudget \
  --exp-class RMTMediumPropK48DynamicFull48RoPE18VectorNormMHABudgetDynamicUnembeddingDirect32
exec python3 /home/xd/projects/xd_tpu_scripts/run_cpu_tests_parallel.py "$PWD" \
  ...
  --test RMTMediumPropTest.test_direct32_boundary_health_initialization_and_gradients \
  --test RMTMediumPropTest.test_direct32_unembedding_matches_full_tail_read_and_gradients \
  --test RMTMediumPropTest.test_fetch_c8_shared_and_independent_keys
