...
parser.add_argument('--num-layers', type=int, default=25)
...
bands={'L0':range(1),'L1-7':range(1,8),'L8-15':range(8,16),'L16-23':range(16,24),**{f'L{i}':range(i,i+1) for i in range(24,args.num_layers)}}
result={}
