...
def validate_attention_kernel(s: str) -> None:
  valid_attention_kernels = ("autoselected", "dot_product", "flash", "cudnn_flash_te", "dot_product_chunk") # lsp
...
def validate_rope_type(rope_type: str) -> None:
  valid_rope_types = ("default", "yarn", "llama3.1", "golden_gate")
...
class _HyperParameters:
  ...
  def user_init(raw_keys):
    ...
    bucket_logging_dir = raw_keys["bucket_logging_dir"]
    if run_name: 
      ...
      raw_keys["bucket_logging_dir"] = os.path.join(base_output_directory, run_name, bucket_logging_dir, "")
