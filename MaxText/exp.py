...
class BamXLSharedBasisLocalVRowSharedColRank4CFp32(
    ...
    # !? vs SharedBasis c664e82 .5444 is health/env/zone matched but cross-runtime; speed delta
    # -0.11% is indistinguishable from zero and does not isolate the architectural saving.
